...
/**
 * !WARNING!
 * Fast formatting, but use this class ONLY when you know that packet ID will not appear in a packet data!
 * @see PacketUtils for safe packet utilities.
 *
 * Utils allow you to interact with packets.
 */
public final class PacketUnsafeUtils extends AbstractPacketUtils {
    private final PacketBootstrap bootstrap;
    /**
     * @param bootstrap PacketBootstrap instance.
     */
    private PacketUnsafeUtils(PacketBootstrap bootstrap) {
        this.bootstrap = bootstrap;
    }

    private static PacketUnsafeUtils instance;
     ...
     */
    public static PacketUnsafeUtils getInstance(PacketBootstrap bootstrap) {
        if (instance == null) {
            instance = new PacketUnsafeUtils(bootstrap);
        }
        return instance;
    }

    public static PacketUnsafeUtils getInstance() {
        if (instance == null) {
            instance = new PacketUnsafeUtils(PacketBootstrap.getInstance());
        }
        return instance;
    }
     ...
     * Example in .handle method in cpServer or in TcpClient:
     *
     * <pre>{@code
